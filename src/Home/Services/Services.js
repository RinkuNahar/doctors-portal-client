            ...
            <div className='services-container grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 ml-16 mt-12 '>
                <div className="card card-compact w-96 bg-base-100 shadow-xl mt-5">
                    ...
                    <div className="card-body text-center">
                        <h2 className="text-xl font-bold">Fluoride Treatment</h2>
                ...
                <div className="card card-compact w-96 bg-base-100 shadow-xl mt-5">
                    ...
                    <div className="card-body text-center">
                        <h2 className="text-xl font-bold">Cavity Filling</h2>
