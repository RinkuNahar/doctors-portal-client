...
const Info = () => {
    return (
        <div className='ml-16 my-12 info'>
            <div className="card container w-96 bg-base-100 shadow-xl bg-gradient-to-r from-secondary to-primary info-container">
            ...
            <div className="card container w-96 bg-base-100 shadow-xl bg-accent  info-container">
                <div className='info-image'>
